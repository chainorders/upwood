...
export class CognitoStack extends cdk.Stack {
	...
	constructor(scope: Construct, id: string, props: StackProps) {
		...
		this.adminRole = new iam.Role(this, `${props.organization}-${props.organization_env}-role-admin`, {
			roleName: `${props.organization}-${props.organization_env}-role-admin`,
			description: "Role which will be assumed by users in cognito admin group",
			assumedBy: new iam.FederatedPrincipal("cognito-identity.amazonaws.com", {
				StringEquals: { "cognito-identity.amazonaws.com:aud": this.userPool.userPoolId },
