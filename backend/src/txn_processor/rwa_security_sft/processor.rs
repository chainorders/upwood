use super::db::{
    ContractConfig, DbToken, RwaSecuritySftDb, TokenHolder, TokenHolderOperator,
...
use crate::{
    ...
    txn_processor::rwa_security_sft::db::DbDepositedToken,
};
...
pub struct RwaSecuritySftProcessor {
...
impl RwaSecuritySftProcessor {
    pub fn database(&self, contract: &ContractAddress) -> RwaSecuritySftDb {
        let db = self
            .client
...
#[async_trait]
impl EventsProcessor for RwaSecuritySftProcessor {
