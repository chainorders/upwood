...
import { default as client } from "./rwaSecuritySft";
import * as types from "./rwaSecuritySft";
	...
	dependencies: {
		tag: {
			oneOf: [
				...
				{
					properties: {
						tag: { enum: ["InsufficientFractionalized"] },
						InsufficientFractionalized: {
							type: "object",
							title: "InsufficientFractionalized",
							properties: {},
						},
					},
				},
				{
					properties: {
						tag: { enum: ["InvalidFractionsRate"] },
						InvalidFractionsRate: {
							type: "object",
							title: "InvalidFractionsRate",
							properties: {},
						},
					},
				},
...
export type initErrorUi =
	...
	| { tag: "InsufficientFractionalized"; InsufficientFractionalized: never }
	| { tag: "InvalidFractionsRate"; InvalidFractionsRate: never };
...
export type AddAgentErrorUi =
	...
	| { tag: "InsufficientFractionalized"; InsufficientFractionalized: never }
	| { tag: "InvalidFractionsRate"; InvalidFractionsRate: never };
export const addTokensRequestJsonSchema: RJSFSchema = {
	type: "object",
	title: "Add Tokens Request",
	properties: {
		tokens: {
			type: "array",
			items: {
...
export type AddTokensRequestUi = {
	tokens: {
		deposit_token_id: {
		...
		fractions_rate: { numerator: number; denominator: number };
	}[];
};
export const addTokensErrorJsonSchema: RJSFSchema = {
	type: "object",
	title: "Add Tokens Error",
	properties: {
		tag: {
			type: "string",
			enum: [
...
export const mintRequestJsonSchema: RJSFSchema = {
	...
	properties: {
		...
		deposited_token_owner: { type: "string", title: "Deposited Token Owner" },
		deposited_amount: { type: "string", title: "Deposited Amount" },
		owner: {
			type: "object",
			title: "Owner",
			properties: { tag: { type: "string", enum: ["Account", "Contract"] } },
...
export const ENTRYPOINTS_UI: {
	...
	addTokens: (props: {
		...
		GenericUpdate<
			types.AddTokensRequest,
			AddTokensRequestUi,
			types.AddTokensError,
			AddTokensErrorUi
		>({
			...props,
			method: client.addTokens,
			requestJsonSchema: addTokensRequestJsonSchema,
			requestSchemaBase64: types.addTokensRequestSchemaBase64,
			errorJsonSchema: addTokensErrorJsonSchema,
			errorSchemaBase64: types.addTokensErrorSchemaBase64,
		}),
	agents: (props: {
		contract: ContractAddress.Type;
		uiSchema?: UiSchema;
