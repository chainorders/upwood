...
import { AccountCircle, CurrencyExchange, Delete, Handshake, OpenInBrowser, Token, ViewModule } from "@mui/icons-material";
...
export default function ContractsList(props: Props) {
	...
	const marketContracts = props.contracts.filter((c) => c.type == ContractType.RwaMarket);
	const nftContracts = props.contracts.filter((c) => c.type == ContractType.RwaSecurityNft);
