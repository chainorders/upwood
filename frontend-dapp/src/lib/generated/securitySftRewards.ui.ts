...
import { default as client } from "./securitySftRewards";
import * as types from "./securitySftRewards";
import {
	GenericInit,
	GenericInvoke,
	GenericUpdate,
...
export const initRequestJsonSchema: RJSFSchema = {
	...
	properties: {
		...
		blank_reward_metadata_url: {
			type: "object",
			title: "Blank Reward Metadata Url",
			properties: {
				url: { type: "string", title: "Url", default: "" },
				hash: {
					type: "object",
		...
		tracked_token_id: {
			type: "string",
			title: "Tracked Token Id",
			default: "",
			format: "byte",
		},
		min_reward_token_id: {
			type: "string",
			title: "Min Reward Token Id",
			default: "",
			format: "byte",
		},
	},
...
export type ClaimRewardsRequestUi = {
	owner:
		| { tag: "Account"; Account: [string] }
		| {
				tag: "Contract";
	...
	claims: { token_id: string; amount: string }[];
};
export const claimRewardsErrorJsonSchema: RJSFSchema = {
	type: "object",
...
export type ClaimRewardsErrorUi =
	| { tag: "ParseError"; ParseError: never }
	| { tag: "LogError"; LogError: never }
	| { tag: "InvalidTokenId"; InvalidTokenId: never }
	| { tag: "InsufficientFunds"; InsufficientFunds: never }
...
export const forcedBurnRequestJsonSchema: RJSFSchema = {
	type: "array",
	items: {
		type: "object",
		title: "",
	...
	title: "Forced Burn Request",
};
export type ForcedBurnRequestUi = {
	token_id: string;
	amount: string;
	owner:
		| { tag: "Account"; Account: [string] }
...
export const forcedBurnErrorJsonSchema: RJSFSchema = {
	type: "object",
	title: "Forced Burn Error",
	properties: {
		tag: {
			type: "string",
			enum: [
...
export type ReceiveAddRewardRequestUi = {
	token_id: string;
	amount: string;
	from:
		| { tag: "Account"; Account: [string] }
...
export const receiveAddRewardErrorJsonSchema: RJSFSchema = {
	type: "object",
	title: "Receive Add Reward Error",
	properties: {
		tag: {
			type: "string",
			enum: [
...
export type ReceiveAddRewardErrorUi =
	| { tag: "ParseError"; ParseError: never }
	| { tag: "LogError"; LogError: never }
	| { tag: "InvalidTokenId"; InvalidTokenId: never }
	| { tag: "InsufficientFunds"; InsufficientFunds: never }
...
export const transferAddRewardErrorJsonSchema: RJSFSchema = {
	type: "object",
	title: "Transfer Add Reward Error",
	properties: {
		tag: {
			type: "string",
			enum: [
...
export type TransferAddRewardErrorUi =
	| { tag: "ParseError"; ParseError: never }
	| { tag: "LogError"; LogError: never }
	| { tag: "InvalidTokenId"; InvalidTokenId: never }
	| { tag: "InsufficientFunds"; InsufficientFunds: never }
...
export const ENTRYPOINTS_UI: {
	...
	claimRewards: (props: {
		...
		GenericUpdate<
			types.ClaimRewardsRequest,
			ClaimRewardsRequestUi,
			types.ClaimRewardsError,
			ClaimRewardsErrorUi
		>({
			...props,
			method: client.claimRewards,
			requestJsonSchema: claimRewardsRequestJsonSchema,
			requestSchemaBase64: types.claimRewardsRequestSchemaBase64,
			errorJsonSchema: claimRewardsErrorJsonSchema,
			errorSchemaBase64: types.claimRewardsErrorSchemaBase64,
		}),
	compliance: (props: {
		contract: ContractAddress.Type;
		uiSchema?: UiSchema;
	...
	forcedBurn: (props: {
		...
		GenericUpdate<
			types.ForcedBurnRequest,
			ForcedBurnRequestUi,
			types.ForcedBurnError,
			ForcedBurnErrorUi
		>({
			...props,
			method: client.forcedBurn,
			requestJsonSchema: forcedBurnRequestJsonSchema,
			requestSchemaBase64: types.forcedBurnRequestSchemaBase64,
			errorJsonSchema: forcedBurnErrorJsonSchema,
			errorSchemaBase64: types.forcedBurnErrorSchemaBase64,
		}),
	...
	receiveAddReward: (props: {
		contract: ContractAddress.Type;
		uiSchema?: UiSchema;
		uiWidgets?: RegistryWidgetsType;
	}) =>
		GenericUpdate<
			types.ReceiveAddRewardRequest,
			ReceiveAddRewardRequestUi,
			types.ReceiveAddRewardError,
			ReceiveAddRewardErrorUi
		>({
			...props,
			method: client.receiveAddReward,
			requestJsonSchema: receiveAddRewardRequestJsonSchema,
			requestSchemaBase64: types.receiveAddRewardRequestSchemaBase64,
			errorJsonSchema: receiveAddRewardErrorJsonSchema,
			errorSchemaBase64: types.receiveAddRewardErrorSchemaBase64,
		}),
	recover: (props: {
		contract: ContractAddress.Type;
		uiSchema?: UiSchema;
	...
	transferAddReward: (props: {
		contract: ContractAddress.Type;
		uiSchema?: UiSchema;
		uiWidgets?: RegistryWidgetsType;
	}) =>
		GenericUpdate<
			types.TransferAddRewardRequest,
			TransferAddRewardRequestUi,
			types.TransferAddRewardError,
			TransferAddRewardErrorUi
		>({
			...props,
			method: client.transferAddReward,
			requestJsonSchema: transferAddRewardRequestJsonSchema,
			requestSchemaBase64: types.transferAddRewardRequestSchemaBase64,
			errorJsonSchema: transferAddRewardErrorJsonSchema,
			errorSchemaBase64: types.transferAddRewardErrorSchemaBase64,
		}),
	unFreeze: (props: {
		contract: ContractAddress.Type;
		uiSchema?: UiSchema;
