...
export class IndexerService {
     ...
     * @throws ApiError
     */
    public static getAdminIndexerContractExists(
     ...
     * @throws ApiError
     */
    public static getAdminIndexerCis2Token(
        contractAddress: string,
        tokenId: string,
     ...
     * @throws ApiError
     */
    public static getAdminIndexerCis2TokenMarket(
        contractAddress: string,
        tokenId: string,
     ...
     * @throws ApiError
     */
    public static getAdminIndexerCis2MarketList(
        contractAddress: string,
    ): CancelablePromise<Array<Market>> {
        return __request(OpenAPI, {
            method: 'GET',
