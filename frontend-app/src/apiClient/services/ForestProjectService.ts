...
export class ForestProjectService {
	 ...
	 * @throws ApiError
	 */
	public static getForestProjectsTokenContractListOwned(): CancelablePromise<PagedResponse_ForestProjectTokenContractAggApiModel_> {
		return __request(OpenAPI, {
			method: "GET",
			url: "/forest_projects/token_contract/list/owned",
		});
	}
