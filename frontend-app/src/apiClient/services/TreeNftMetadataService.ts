...
export class TreeNftMetadataService {
	 ...
	 * @throws ApiError
	 */
	public static postAdminTreeNftMetadata(requestBody: AddMetadataRequest): CancelablePromise<TreeNftMetadata> {
		return __request(OpenAPI, {
			method: "POST",
	 ...
	 * @throws ApiError
	 */
	public static getAdminTreeNftMetadata(id: string): CancelablePromise<TreeNftMetadata> {
		return __request(OpenAPI, {
			method: "GET",
	 ...
	 * @throws ApiError
	 */
	public static deleteAdminTreeNftMetadata(id: string): CancelablePromise<any> {
		return __request(OpenAPI, {
			method: "DELETE",
			url: "/admin/tree_nft/metadata/{id}",
			path: {
