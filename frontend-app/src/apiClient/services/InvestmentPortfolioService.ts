...
export class InvestmentPortfolioService {
     ...
     * @throws ApiError
     */
    public static getPortfolioAggregate(
        now?: string,
    ): CancelablePromise<InvestmentPortfolioUserAggregate> {
     ...
     * @throws ApiError
     */
    public static getPortfolioValueLastNMonths(
        months: number,
        now?: string,
    ): CancelablePromise<Array<PortfolioValue>> {
        return __request(OpenAPI, {
            method: 'GET',
