				...
				<div className="container">
					<div className="container-in">
						<div className="col-12">
							<div className="news-description" dangerouslySetInnerHTML={{ __html: data.large }}></div>
						</div>
					</div>
				</div>
			</div>
