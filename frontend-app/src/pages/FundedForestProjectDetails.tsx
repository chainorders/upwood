                ...
                <div className="container">
                    <div className="container-in">
                        ...
                        <div className="col-2 col-m-full fr">
                            <Button icon={NotifyNon} style={'style4 text-align-left-on-mob'} text={'NOTIFY ME'} link={''} active={false} call={openNotifyShare} />
                            {/* <Button icon={NotifySuccess} style={'style5 text-align-left-on-mob'} text={'NOTIFY ME'} link={''} active={false} /> */}
                        </div>
