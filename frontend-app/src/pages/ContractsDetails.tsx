...
export default function ContractsDetails() {
    ...
    return (
        <div className="contract">
            ...
            <PageHeader userFullName={user.fullName} initials={user.initials} parts={[{ name: "Contracts" }]} />
                ...
                <div className="container-in">
                    <div className="col-12">
                        <div className="contract-card">
                            ...
                            <div className="fs">
                                <div className="fl">Signed date : <span>{data.signed_date}</span></div>
                                <div className="fr">Tokens : <span>{data.tokens}</span></div>
                                <div className="clr"></div>
                            </div>
