		...
		<div className="verticle-navigation">
			<ul>
				{props.navItems.map((item, index) => (
					<li key={index} className={item.isActive ? "active" : ""} onClick={props.closeMenu}>
						<img
			...
			<div className="header">
				<div className="top">
					<div className="logo fl">
						<img src={logoImage} alt="" width={176} height={38} />
					</div>
					<img src={menuIcon} width={40} height={40} className="menuopen-bar fr" onClick={openMenu} />
					<img src={closeMenuIcon} width={40} height={40} className="menuclose-bar fr" onClick={openMenu} />
					<div className="clr"></div>
				</div>

				<span className="logout" onClick={props.logout}>
					<img className="icon" src={logout} alt="" width={24} height={24} />
					<span
						className="text"
						onClick={() => {
							console.log("logout");
