                    ...
                    <div className="container">
                        <div className="container-in">
                            ...
                            <div className="col-8 fr col-m-full">
                                {company_name_edit ? 
                                <div>
                                    <input type="text" placeholder="Enter full name" value={company_name} className="boxt withedit fl" onChange={(e)=> setCompanyName(e.target.value)} />
                                    <img src={saveRow} alt="" className="saverow fr" onClick={()=> setCompanyNameEdit(false)} />
                                    <div className="clr"></div>
                                </div>
                                :
                                <div className="boxl lg">{company_name} <span className="fr"><img src={editRow} onClick={()=> setCompanyNameEdit(true)} /></span></div>
                                }
                            </div>
                            <div className="clr"></div>
                            <div className="space-15"></div>
                            ...
                            <div className="col-12">
                                <div className="head">Entity members <span className="headlink fr" onClick={()=> setMembersScreen(true)}>Add members</span></div>
                            </div>
                            <div className="space-15"></div>
                            {members.length === 0 && (
                            <div className="col-12">
                            ...
                            <>
                                ...
                                <div key={index}>
                                        ...
                                        <div className="col-3 fr"><span className={`sty ${item.status}`}>{item.status}</span><img src={Remove} alt="" className="styremove fr" /></div>
                                        <div className="clr"></div>
                                        <div className="space-15"></div>
                                    </div>  
                                ))}
                    ...
                    <div className="container">
                        <div className="container-in">
                            ...
                            <div className="col-12">
                                ...
                                <div className="space-15"></div>
                                <div className="field">
                                    <input className="textField center" placeholder="Enter email address" value={memberemail} onChange={(e) => setMemberEmail(e.target.value)} />
                                </div>
                                <div className="space-30"></div>
                            </div>
                            <div className="clr"></div>
