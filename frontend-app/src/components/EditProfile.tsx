						...
						<div className="container">
							<div className="container-in">
								...
								<div className="col-12">
									<div className="head">
										Security
										<span className="headlink fr showonmobile" onClick={() => set2FAScreen(true)}>
											ENABLE
										</span>
								...
								<div className="col-12">
									...
									<span className="headlink fr hideonmobile" onClick={() => set2FAScreen(true)}>
										ENABLE
									</span>
								</div>
								{/* <div className="col-12">
					...
					<div className="cl-area edo">
						<div className="container">
							<div className="container-in">
								<div className="space-20"></div>
								<div className="col-12">
									<div className="head text-align-center">Please check your email for create</div>
