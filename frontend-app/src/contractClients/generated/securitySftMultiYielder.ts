...
export type SetTreasuryRequest = { Account: [string] } | { Contract: [{ index: number; subindex: number }] };
export const setTreasuryRequestSchemaBase64 = "FQIAAAAHAAAAQWNjb3VudAEBAAAACwgAAABDb250cmFjdAEBAAAADA==";
...
export type event =
	...
	| { TreasuryUpdated: [{ Account: [string] } | { Contract: [{ index: number; subindex: number }] }] };
...
export const securitySftMultiYielder = {
	init: new InitMethod<initRequest>(
		ModuleReference.fromHexString("5479d6aa5a7d9bc920bff2ef2d5430b6bad2d545f3bdbbfd409593152424a8bc"),
