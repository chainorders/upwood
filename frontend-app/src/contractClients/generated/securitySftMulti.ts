...
export const CONTRACT_NAME = "security_sft_multi";
export type initRequest = {
	...
	agents: Array<{
		...
		roles: Array<
			...
			| { RemoveToken: Record<string, never> }
			| { SetTokenMetadata: Record<string, never> }
		>;
	}>;
};
export const initRequestSchemaBase64 =
	"";
...
export const addAgentRequestSchemaBase64 =
	"";
export type AddTokenError =
	| { ParseError: Record<string, never> }
	| { LogError: Record<string, never> }
	| { InvalidTokenId: Record<string, never> }
	| { InsufficientFunds: Record<string, never> }
	...
	| { RecoveredAddress: Record<string, never> }
	| { SecurityNotSet: Record<string, never> };
export const addTokenErrorSchemaBase64 =
	"";
...
export type RemoveTokenError =
	...
	| { RecoveredAddress: Record<string, never> }
	| { SecurityNotSet: Record<string, never> };
export const removeTokenErrorSchemaBase64 =
	"";
export type RemoveTokenRequest = string;
export const removeTokenRequestSchemaBase64 = "HQA=";
...
export const ENTRYPOINTS: Record<string, EntrypointName.Type> = {
	...
	removeToken: EntrypointName.fromString("removeToken"),
...
export const securitySftMulti = {
	init: new InitMethod<initRequest>(
		ModuleReference.fromHexString("5e346272d1aa202abf91ef3a788d31caea4bb284a28ac412a3680c06a9d293a4"),
		ContractName.fromString("security_sft_multi"),
	...
	addToken: new ReceiveMethod<AddTokenRequest, never, AddTokenError>(
		ContractName.fromString("security_sft_multi"),
		EntrypointName.fromString("addToken"),
		addTokenRequestSchemaBase64,
		undefined,
		addTokenErrorSchemaBase64,
	),
	...
	removeToken: new ReceiveMethod<RemoveTokenRequest, never, RemoveTokenError>(
		ContractName.fromString("security_sft_multi"),
		EntrypointName.fromString("removeToken"),
		removeTokenRequestSchemaBase64,
		undefined,
		removeTokenErrorSchemaBase64,
	),
...
export default securitySftMulti;
