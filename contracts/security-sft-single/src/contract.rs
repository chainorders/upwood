...
use concordium_protocols::concordium_cis2_security::{
    AgentUpdatedEvent, ComplianceAdded, FreezeParam, IdentityRegistryAdded, Paused, RecoverEvent,
    TokenFrozen,
};
use concordium_std::*;
...
pub fn set_token_metadata(
    ...
    {
        state.token.metadata_url = token_metadata.clone().into();
        logger.log(&Event::Cis2(Cis2Event::TokenMetadata(TokenMetadataEvent {
            token_id,
...
#[receive(
    ...
    enable_logger,
    mutable,
    parameter = "super::types::TransferParams",
    error = "Error"
)]
pub fn transfer(
    ctx: &ReceiveContext,
    ...
    } in transfers
    {
        ...
        if let Receiver::Contract(contract, entrypoint) = to {
            host.invoke_contract(
                &contract,
                &OnReceivingCis2Params {
                    token_id,
