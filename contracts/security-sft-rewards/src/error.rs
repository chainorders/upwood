...
impl Error {
    fn error_code(&self) -> NonZeroI32 {
        NonZeroI32::new(match self {
            ...
            Error::AgentNotFound => -9,
            Error::OnlyAccount => -10,
            Error::InvalidDepositData => -11,
            Error::Cis2WithdrawError => -12,
            Error::InsufficientDeposits => -13,
            Error::InvalidRewardRate => -14,
            Error::RecoveredAddress => -15,
            Error::InsufficientRewardFunds => -16,
            Error::InvalidRewardTokenId => -17,
        })
        .unwrap()
    }
}
