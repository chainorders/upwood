...
use concordium_std::{Address, ContractAddress, Deserial, OwnedContractName, SchemaType, Serial, Serialize};
use super::{
    cis2_test_contract::{ICis2Contract, ICis2ContractUnitTokenExt},
    test_contract_client::*
};

//Euroe types have been copied so that the concordium std and cis2 crates have independent dependencies
