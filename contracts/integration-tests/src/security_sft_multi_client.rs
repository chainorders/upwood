...
pub const MODULE_BYTES: &[u8] = include_bytes!("../../security-sft-multi/contract.wasm.v1");
pub const CONTRACT_NAME: ContractName = ContractName::new_unchecked("init_security_sft_multi");

#[derive(Clone, Copy)]
pub struct SftMultiTestClient(pub ContractAddress);
impl ContractPayloads<InitParam> for SftMultiTestClient {
...
impl Cis2Payloads<InitParam, TokenId, TokenAmount> for SftMultiTestClient {}
impl ContractTestClient<InitParam> for SftMultiTestClient {
    fn new(contract_address: ContractAddress) -> Self { Self(contract_address) }
}
impl Cis2TestClient<InitParam, TokenId, TokenAmount> for SftMultiTestClient {}
impl Cis2SecurityPayloads<InitParam, AgentRole, TokenId, TokenAmount> for SftMultiTestClient {}
impl Cis2SecurityTestClient<InitParam, AgentRole, TokenId, TokenAmount> for SftMultiTestClient {}
