...
/// Creates a new `TestDbContext` with the given base URL and database name.
///
/// This function first connects to the Postgres database using the provided base URL, and then creates a new database
/// with the given name. The created `TestDbContext` instance can be used to interact with the test database.
///
/// # Arguments
/// * `base_url` - The base URL for the Postgres database connection.
/// * `db_name` - The name of the test database to create.
///
/// # Returns
/// A new `TestDbContext` instance.
impl TestDbContext {
